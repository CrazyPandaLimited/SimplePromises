...
Предоставляет возможность использовать Promises для написания асинхронного кода. Реализация для использования в одном главном потоке, многопоточность не поддерживается!
